...
describe('Problem API:', function() {
  ...
  describe('POST /api/problems', function() {
    ...
    it('should respond with the newly created problem', function() {
      expect(newProblem.name).to.equal('New Problem');
      expect(newProblem.info).to.equal('This is the brand new problem!!!');
    });
  });
  ...
  describe('GET /api/problems/:id', function() {
    ...
    it('should respond with the requested problem', function() {
      expect(problem.name).to.equal('New Problem');
      expect(problem.info).to.equal('This is the brand new problem!!!');
    });
  });
  ...
  describe('PUT /api/problems/:id', function() {
    ...
    it('should respond with the original problem', function() {
      expect(updatedProblem.name).to.equal('New Problem');
      expect(updatedProblem.info).to.equal('This is the brand new problem!!!');
    });
    ...
    it('should respond with the updated problem on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          expect(problem.name).to.equal('Updated Problem');
          expect(problem.info).to.equal('This is the updated problem!!!');
