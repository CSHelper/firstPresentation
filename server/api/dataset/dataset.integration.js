...
describe('Dataset API:', function() {
  ...
  describe('PUT /api/datasets/:id', function() {
    ...
    it('should respond with the original dataset', function() {
      expect(updatedDataset.name).to.equal('New Dataset');
      expect(updatedDataset.info).to.equal('This is the brand new dataset!!!');
    });
