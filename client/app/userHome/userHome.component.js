...
import routes from './userHome.routes';
...
export default angular.module('firstPresentationApp.userHome', [uiRouter])
  .config(routes)
  .component('userHome', {
    template: require('./userHome.html'),
    controller: UserHomeComponent,
    controllerAs: 'userHomeCtrl'
  })
  .name;
